...
import { FaFilter, FaTh, FaThLarge, FaSearch, FaSpinner } from 'react-icons/fa';
...
const ProductsPage = () => {
    ...
    // Get displayed products (limited)
    const displayedProducts = products.slice(0, displayLimit);
    const hasMore = displayLimit < products.length;

    // Get category counts based on current filters (excluding category filter)
                ...
                <div style={styles.content}>
                    ...
                    <div style={{
                        ...
                        <div style={styles.resultsInfo}>
                            <p>Showing {displayedProducts.length} of {products.length} products</p>
                            {activeCategory !== 'All' && (
